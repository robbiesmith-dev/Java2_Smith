    ...
    public void updateList()
    {
       if(isNetworkAvailable())
       {
           if (mSpinnerText.equals("Top Box Office"))
           {
               ...
               //Create Adapter
               ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, simple_list_item_1, JSON.boxOfficeMovies);
               //Set Adapter
           ...
           else
           {
               ...
               //Create Adapter
               ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, simple_list_item_1, JSON.rentalMovies);
               //Set Adapter
               setListAdapter(adapter);
           }
       }
